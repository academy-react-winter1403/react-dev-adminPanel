...
import { setCourseInfoStepOne } from "../store/allDataAddCourse";
...
const FirstStageCourse = ({ stepper }) => {
  // ** Hooks
  const {
    control,
    handleSubmit,
  ...
  const onSubmit = (data) => {
    dispatch(setCourseInfoStepOne(data));
    console.log("fileImage", ImageCourse);
    stepper.next();
  };
...
export default FirstStageCourse;

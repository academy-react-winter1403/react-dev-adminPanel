...
const CourseReserved = () => {
  ...
  const exportHeaderData = ["نام دانشجو", "نام دوره", "وضعیت", "اقدامات"];
  const {courseReservData, RowsOfPage, PageNumber, Query} = useSelector(
    (state) => state.courseReservDataSlice
  );
  ...
  }, [courseReservData, PageNumber, RowsOfPage, Query])
